...
export const metadata = {
  title: "Expense The subscription Tracker",
  description: "Track all your suscriptions analytics!",
};
    ...
    <footer>
      ...
      <div className="footer-content">
        <div>
          ...
          <p className="copyright">© Copyright 2025, Jesus Diaz.<br />All rights reserved.</p>
        </div>
        <div>
